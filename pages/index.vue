<template>
  <div class="w-full h-full bg-blue-300 bg-gradient-to-b">
    ...
    <div class="grid h-screen grid-cols-4 pt-28 justify-items-stretch">
      ...
      <div v-else class="flex-col col-span-3 pt-6 mx-6 space-y-6">
        <h1 class="text-6xl text-center text-white"> {{cityfocused.name}} - {{region}}</h1>
...
export default {
  data() {
    return {
      loading: true,
      cityfocused: null,
      tab: [dieppe, bourges, paris, lehavre],
      temp: 0,
      wind: 0,
      windDir: "",
      last_updated: "",
